...
//Sempra quando criamos um estado para um array ou objeto: e necessario informar manualmente o tipo da variavel
...
//Toda vez que eu mudo algo na funcao ela e executada denovo
const CreatePoint = () => {
    ...
    //Se o segundo paramatro estiver vazio ele so escuta a funcao uma unica vez.
    useEffect(() => {
